...
## [0.36.0](https://github.com/robottwo/bishop/compare/v0.35.0...v0.36.0) (2026-02-05)
...
* Save code review report to file output ([#67](https://github.com/robottwo/bishop/issues/67)) ([212171c](https://github.com/robottwo/bishop/commit/212171ca34a121c0c3a0588006ac931b78a1d93f))
* updated the images and html for the github pages ([#76](https://github.com/robottwo/bishop/issues/76)) ([3d2e545](https://github.com/robottwo/bishop/commit/3d2e5454d95a082610bf8196c6d91ad16ae9ff1d))
...
* Remove the legacy 'always' response option from all tools and consolidate permission management through the interactive 'manage' menu.

### Features

* add -ver flag to display BuildVersion\n\n- Implemented a new command-line flag '-ver' to print the current BuildVersion. ([a452224](https://github.com/robottwo/bishop/commit/a452224a1ccf8210648204f1361e4324c6a850c9))
* add best practices and constants for prediction ([b5564d3](https://github.com/robottwo/bishop/commit/b5564d3717b1d0441142c5ac848f4bc6f188cb10))
* add command evaluation functionality ([dfdda6d](https://github.com/robottwo/bishop/commit/dfdda6dcaed4acd10f3f4629f6689e8a4f0f700f))
* add compgen command implementation and tests ([0f4f983](https://github.com/robottwo/bishop/commit/0f4f983a81b922cc8eaf541cb3cc8a908ed3d367))
* add configurable minimum shell prompt height\n\nIntroduced a new environment variable GSH_MINIMUM_HEIGHT to configure the minimum number of lines the shell prompt occupies. Updated the shell and environment components to utilize this new configuration. ([5aa0abc](https://github.com/robottwo/bishop/commit/5aa0abc77718705d1aa64b4c92ec5f21407558bb))
...
* add help flag to main command\n\nAdded a help flag (-h) to the main command to display usage information. Updated ROADMAP.md to reflect the reordering of tasks. ([452e017](https://github.com/robottwo/bishop/commit/452e01720f30a03b0707a1464059951acaa067f6))
* add history-based command prefix prediction ([d6b7e83](https://github.com/robottwo/bishop/commit/d6b7e838654ddcb5e5d1b14c05d7a21be266db74))
...
* add interactive permissions menu system ([a5c7083](https://github.com/robottwo/bishop/commit/a5c708346f676396975c342c62db9ff6a3c67018))
* add interrupt handling for chat sessions ([657c27c](https://github.com/robottwo/bishop/commit/657c27cba094bf6fd061965a1bfa017db351f961))
...
* add more read-only commands to pre-approved list ([c05851c](https://github.com/robottwo/bishop/commit/c05851cec47d95fb9cfdc7eb54aca18af9d45b30))
...
* add pre-approved command patterns to skip confirmation ([a765e43](https://github.com/robottwo/bishop/commit/a765e43164dc164f31d636e67c591ce88d556a2d))
* add support for chat macros ([527b2c1](https://github.com/robottwo/bishop/commit/527b2c106dc6fc134918c68823c0372a8852f268))
* add support for multiple iterations in model evaluation ([73f2941](https://github.com/robottwo/bishop/commit/73f2941fe0bb19b0ae94cbede736c2206792abb7))
* add total count support to analytics command ([7f6484f](https://github.com/robottwo/bishop/commit/7f6484fce90c7da7cd0774c4f0b94825c3224b9d))
* **agent:** add preview code edits feature\n\nImplemented a feature to preview code edits before applying them. Updated ROADMAP.md to reflect the completion of this task. ([826cd9e](https://github.com/robottwo/bishop/commit/826cd9efb5ecb0588a88e233d31e4586180161d1))
* **agent:** integrate history manager into agent and bash tool ([012e4a3](https://github.com/robottwo/bishop/commit/012e4a3b68c19bb132bba0e905ba8acedaff4d5f))
* allow backspace to clear prediction at empty input ([428330a](https://github.com/robottwo/bishop/commit/428330a52e746e6cc5bc0c54ccdcb2bb57a9e7fb))
* attemp to produce homebrew tap ([983197b](https://github.com/robottwo/bishop/commit/983197b45824ebcd0cf348c6d3923018a6383e84))
...
* basic bash completion support ([f2b4f19](https://github.com/robottwo/bishop/commit/f2b4f1986e9eb04cd3914e535246547494b94a03))
* basic support for complete command ([6f9d1a8](https://github.com/robottwo/bishop/commit/6f9d1a82e0520e32cb6d26a848a1dc601ae00908))
* **core:** add system info retriever and update roadmap\n\nAdded a new SystemInfoContextRetriever to the shell core for retrieving system information. Updated the ROADMAP.md to reflect recent changes and future plans. ([959f80f](https://github.com/robottwo/bishop/commit/959f80f149a8ea567d6a6a44b245488a88921fb8))
* enhance LLM client with special headers for openrouter.ai and update roadmap ([290d0fc](https://github.com/robottwo/bishop/commit/290d0fc2a15619a7ec8aca7b75422549891e7503))
* enhance shell input with history navigation and improved utils ([d066369](https://github.com/robottwo/bishop/commit/d066369b56a9a9ba1e1d761a0b015d88202c7005))
* enhance shell prompt and command execution tracking\n\nUpdated .gshrc.starship for richer prompt details including command status and duration. Improved command execution tracking in shell.go and bash.go with duration and exit code handling. ([e16cb84](https://github.com/robottwo/bishop/commit/e16cb8489d9465e601fa6bfbbab3f6d51f2e343a))
* explain prediction ([d7feb37](https://github.com/robottwo/bishop/commit/d7feb3767dd7e010253a1e715773e1cb996a857e))
* implement agent controls and add token tracking ([6793455](https://github.com/robottwo/bishop/commit/679345538a793505b96cf809a39ba24abc8cfa01))
* implement message pruning for agent chat\n\nAdded a new function to prune agent messages based on a context window size defined by GSH_AGENT_CONTEXT_WINDOW_TOKENS. Updated .gshrc.default and added tests for the new functionality. ([909bb46](https://github.com/robottwo/bishop/commit/909bb460f4ce8e9a68633d3e356630880ea86910))
* Import complete gsh project with full git history ([2254090](https://github.com/robottwo/bishop/commit/2254090636d3283082338f0721ea2208c240d237))
...
* improve command regex generation with heuristic-based subcommand detection ([8beff60](https://github.com/robottwo/bishop/commit/8beff6061570bf984d63a4abf7aed3b317aba20e))
* improve Ctrl+C handling and interrupt detection in gline app ([cada44d](https://github.com/robottwo/bishop/commit/cada44de88b4072548f35d6a93ce9924a69fefa4))
* improve pre-approved command patterns ([8c60662](https://github.com/robottwo/bishop/commit/8c60662ac66bba90364d29c01b788eb396bad461))
...
* make rag context types configurable ([11b8036](https://github.com/robottwo/bishop/commit/11b8036e373ba0962b60e0506bd47c901dabb231))
* release aur sources ([af0aeb7](https://github.com/robottwo/bishop/commit/af0aeb7bea9e6873cd855559419020cdb4a0cd48))
* release to AUR ([ec9cf1c](https://github.com/robottwo/bishop/commit/ec9cf1c0915811584748c2347c1d2cfb331a1a12))
...
* self update ([f863a39](https://github.com/robottwo/bishop/commit/f863a39cb39175f04651ec96b11eb001df922713))
* show build version in prompt when in dev mode ([bad7a27](https://github.com/robottwo/bishop/commit/bad7a270561563fdb98d3136992300f792846a9f))
* **subagent:** add support for Roo YAML mode files ([314941a](https://github.com/robottwo/bishop/commit/314941aa88250ec5a5a5e1193fa5ca37b9d8db8c))
* support history built-in command ([c9710cb](https://github.com/robottwo/bishop/commit/c9710cb3407727e7507a76391180de0544b28fc1))
* support shell opts ([d335891](https://github.com/robottwo/bishop/commit/d33589131ce7a38dacd0f88de8911bd1768a7f56))
* track prediction history locally ([f1a0c89](https://github.com/robottwo/bishop/commit/f1a0c89ac8ed3896240514daaf581db11faae692))


### Bug Fixes

* add source archive to goreleaser ([08c3c8c](https://github.com/robottwo/bishop/commit/08c3c8c7990a622ba07aeb5e81179fd720448d54))
...
* allow nil temperature and parallel tool calls config ([0fbab29](https://github.com/robottwo/bishop/commit/0fbab29345d049be0c18ffd300094d42940ff062))
* always start output messages with gsh: ([a7e3331](https://github.com/robottwo/bishop/commit/a7e33317a2fcd3f247be26238f0317211f2cd9d1))
* analytics file path and null pointer handling ([a8ab90b](https://github.com/robottwo/bishop/commit/a8ab90bf992eadb9987cc514cb74ea8e25bc4cc7))
* attempt to fir aur sources release ([762c1b5](https://github.com/robottwo/bishop/commit/762c1b5db76c83899750709c71ab4dc1498714cc))
* avoid structured output for predict and explain ([6ab1825](https://github.com/robottwo/bishop/commit/6ab1825835a3a055d17906d4bafcf4028107d8a1))
* change error logs to warnings in env.go\n\n- Updated error logs to warnings for parsing environment variables. ([7f0efa1](https://github.com/robottwo/bishop/commit/7f0efa10d803f9a26285c9660795ca421233c6aa))
* continue fixing aur sources release ([b42ee5c](https://github.com/robottwo/bishop/commit/b42ee5c240e7dac2e69ced66f162da3d9e13b749))
* continue fixing aur sources release ([eb17ad3](https://github.com/robottwo/bishop/commit/eb17ad3b9355eff4fa41ba473d5ad1897768f8bd))
* continue fixing aur sources release ([3b08fdf](https://github.com/robottwo/bishop/commit/3b08fdfe688806b33b91accc8dd496c48c9f3d7a))
* continue fixing aur sources release ([648b11a](https://github.com/robottwo/bishop/commit/648b11a2783566adcfdea90ae33d0c86ef012351))
* correct login shell profile paths ([84b9437](https://github.com/robottwo/bishop/commit/84b9437a4b956158ed5feb155cc0cdcb269b043c))
...
* correctly clear preview after command execution ([8c0642e](https://github.com/robottwo/bishop/commit/8c0642e9264807a442860e3e93f27da7cdd06d8d))
...
* disable parallel tool calls for agent chat ([ac04d32](https://github.com/robottwo/bishop/commit/ac04d3235c2eb36ba62a3d07bf22b31c9351f7da))
* ensure relative paths are resolved to absolute paths in tools ([12c64e4](https://github.com/robottwo/bishop/commit/12c64e431ebc691292a4d5fd5ad05362a7afacdb))
* fix an unresolved merge in the default config file. ([1efb885](https://github.com/robottwo/bishop/commit/1efb885f51578f739a53206837d24317c0403961))
* fix an unresolved merge in the default config file. ([028a57f](https://github.com/robottwo/bishop/commit/028a57f88ccbb92a51021b3842fcda8180eee3e1))
* fix goreleaser pipeline ([2e9ae6d](https://github.com/robottwo/bishop/commit/2e9ae6ddb714a7aa8944bc05f7916bd57d202d23))
* fix homebrew tap formula release ([2e6106c](https://github.com/robottwo/bishop/commit/2e6106ce6ac9ebd26eee4b92367c7a15f8e90d6b))
* fix release pipeline ([b70b29c](https://github.com/robottwo/bishop/commit/b70b29c3366455e6dfedb0537f7128f34b4c9221))
* fix rendering for multi-line agent response ([cef8dc5](https://github.com/robottwo/bishop/commit/cef8dc51f332eabac8fbd371b105c2b2aa9f7a15))
* fix test dependencies on the local system ([52efcf4](https://github.com/robottwo/bishop/commit/52efcf4d506fd6e868ac8ab77f633c60a0b05fcc))
* force a new version release ([6446be4](https://github.com/robottwo/bishop/commit/6446be4a47f0e706e016e6988d261e9cbc879b69))
* force new release ([e6aefd3](https://github.com/robottwo/bishop/commit/e6aefd3111354691f0d57ca3eef3c11ff1ec2307))
* force vesion update ([550a59c](https://github.com/robottwo/bishop/commit/550a59c5485d761653bdd48878ccaf3bb01d5a65))
* improve command regex generation and test reliability ([d01934f](https://github.com/robottwo/bishop/commit/d01934ff649e0f1272efd6e6e931320a8e3d0c70))
* improve Ctrl+C handling and testability in completion system ([4a5afeb](https://github.com/robottwo/bishop/commit/4a5afeb1f823b2193f8c8e8cf012b68a90dd5f93))
* improve file completion to handle home dir, absolute, and relative paths consistently ([0283834](https://github.com/robottwo/bishop/commit/02838348152710f726afc8fc2139454c02999fb7))
* improve file completion to preserve path prefix and earlier arguments ([6d107cb](https://github.com/robottwo/bishop/commit/6d107cbdbb0b0a196da058c8074870003d73282b))
* improve file creation confirmation UI ([1cded2c](https://github.com/robottwo/bishop/commit/1cded2c011102f868f1ac7d06627419db2f1836e))
* improve file diff preview when creating existing files ([1e865f9](https://github.com/robottwo/bishop/commit/1e865f9c7c01fe6c3db74043dba12a995075bdba))
* improve file edit confirmation UI ([d850c97](https://github.com/robottwo/bishop/commit/d850c97898acc5a5ab5dcec90a315ac5c725b1ca))
* improve login shell detection ([6623ad6](https://github.com/robottwo/bishop/commit/6623ad64d5fe483514a331625fa76aa785d67394))
* improve message pruning to keep early and recent context ([777be1f](https://github.com/robottwo/bishop/commit/777be1f8b677e9a84f0f37620e688a631d3dadf3))
* improve privacy for printed diffs ([6545c29](https://github.com/robottwo/bishop/commit/6545c2936041e9533fd6cdd835a7c417b544e1e1))
* improve privacy of printed paths ([309f2a6](https://github.com/robottwo/bishop/commit/309f2a6de234065f419bed131664f256fa5acf54))
* improve user confirmation handling in tools ([7a11590](https://github.com/robottwo/bishop/commit/7a115909695ee9ce0485a4c1ff7a57dd21bd2f44))
* improve viewfile tool default behavior ([ef45e89](https://github.com/robottwo/bishop/commit/ef45e89a1867b1cf6a4ad17dbc3f9606f20d9fd1))
* improved rendering for token stats ([d513e49](https://github.com/robottwo/bishop/commit/d513e494d0efa683edcced9bb6a9fd2ce52906f1))
* log command line args ([03d6e3a](https://github.com/robottwo/bishop/commit/03d6e3a32eac22a252870788481c2803b93ea7d8))
* make bash output buffer thread-safe ([4ab74ab](https://github.com/robottwo/bishop/commit/4ab74ab747e4e1f6e058135d5f7e285dc7838459))
* optimize verbose history format by grouping by directory ([a49432f](https://github.com/robottwo/bishop/commit/a49432f17a4166067d2c608a7be574b9e7d81854))
...
* put context into agent system message ([0f28fc3](https://github.com/robottwo/bishop/commit/0f28fc374bc166c3c3874853c41a39280e1c2606))
* read /etc/profile as login shell ([33370d0](https://github.com/robottwo/bishop/commit/33370d09d7e9972a6c264668c02d991de48853f1))
* remove done tool and add end_turn finish reason ([c5819f4](https://github.com/robottwo/bishop/commit/c5819f4eb9fb7420c753fd75263219dac15281ff))
* remove manage permissions from file operations ([c7367ed](https://github.com/robottwo/bishop/commit/c7367ed7386e5fab6824a0c497755d084c68ccfa))
* remove source files from gsh-bin aur release script ([1f42fb2](https://github.com/robottwo/bishop/commit/1f42fb2c429eead0175965fd37a5d9156defb156))
* removed chain of thought when doing prediction to reduce token usage and improve latency ([1f5ee65](https://github.com/robottwo/bishop/commit/1f5ee654b6e266225b0b40d72cc0b65a383ee99a))
...
* replace charmbracelet/x/ansi with muesli/reflow for text wrapping ([aaf4fe5](https://github.com/robottwo/bishop/commit/aaf4fe5f1853f21309b663cd8af7e34f3ab49d90))
* rollback shellopts change ([961720a](https://github.com/robottwo/bishop/commit/961720acdeaf1103af986a45e988d4c270b1b2ab))
* set SHELL environment variable correctly ([88a2471](https://github.com/robottwo/bishop/commit/88a2471656f3fa878940b0d66d4794c3f4312024))
* skip evaluation UI when not in terminal ([e733243](https://github.com/robottwo/bishop/commit/e7332435c305497c22b3cc307c6dbd0cb2af77be))
* standardize output formatting across tools using gline.RESET_CURSOR_COLUMN ([0249a45](https://github.com/robottwo/bishop/commit/0249a456c606d595c33c513694c526c4deeabccf))
...
* try fixing goreleaser config ([e17024a](https://github.com/robottwo/bishop/commit/e17024af199bc9db91377076ab696292e0a98c44))
* tweak agent instructions to emphasize understanding diff before composing commit messages ([0314b67](https://github.com/robottwo/bishop/commit/0314b67afdeea149f1430a383354bf5578037fa5))
* tweak agent prompts ([0ef096c](https://github.com/robottwo/bishop/commit/0ef096cf5eee74021f1bed28d7c2d158b3a289bb))
* update .gshrc.starship configuration ([9de5ec6](https://github.com/robottwo/bishop/commit/9de5ec6c5df3ab25e3602619b15047bd870c2fd4))
* update bash and gline tools ([d9ed410](https://github.com/robottwo/bishop/commit/d9ed410c3c385cbee6fc8999c5ddf7fe49b9b945))
* update default context types for explanation ([dc7d1d1](https://github.com/robottwo/bishop/commit/dc7d1d1ac69d142a2e1009803575b55f30136ba2))
* update JSON schema descriptions and add unit test for bash tool ([23caedb](https://github.com/robottwo/bishop/commit/23caedb5dd43df9b0f15920bf9015722db76c702))
* update shell.go to improve command execution handling ([727f904](https://github.com/robottwo/bishop/commit/727f9049d4fa780f56a31bbe396b47e8128045eb))
...
* **viewfile:** adjust line indexing to be 1-based and handle edge cases ([a4c535e](https://github.com/robottwo/bishop/commit/a4c535e96965101010b9dc0ccd3fc57767b39a1b))


### Code Refactoring

* remove legacy 'always' workflow, consolidate on 'manage' menu system ([494a105](https://github.com/robottwo/bishop/commit/494a105e5865081080df8e6367450fc6211f9481))
